...
SECRET_KEY = 'django-insecure-a7dav_)x%ftu89fnb*u!in(ftkq+wlub-w&r4p-e2eq31r9zkv'
...
REST_FRAMEWORK = {
    ...
    # To avoid error “AttributeError at / ‘AutoSchema’ object has no attribute ‘get_link’“.
